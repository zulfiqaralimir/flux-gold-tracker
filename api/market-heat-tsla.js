...
// Same RSI/MACD/Pulse Speed logic as api/market-heat.js, applied to Tesla.
...
export default async function handler(req, res) {
    ...
    try {
        ...
        console.log(`✅ Tesla signals calculated: ${signalType} (Strength: ${signalStrength}/10, Heat: ${latestRSI.toFixed(1)})`);
