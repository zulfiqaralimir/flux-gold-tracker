...
export default async function handler(req, res) {
    ...
    try {
        ...
        console.log(`✅ S&P 500 signals calculated: ${signalType} (Strength: ${signalStrength}/10, Heat: ${latestHeat.toFixed(1)})`);
        ...
        console.error('❌ Error calculating S&P 500 signals:', error);

        res.status(500).json({
            success: false,
            error: 'Failed to calculate S&P 500 market signals. Please try again later.'
        });
    }
}
