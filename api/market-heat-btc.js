...
// Same RSI/MACD/Pulse Speed logic as api/market-heat.js, applied to Bitcoin.
...
export default async function handler(req, res) {
    ...
    try {
        ...
        console.log(`✅ Bitcoin signals calculated: ${signalType} (Strength: ${signalStrength}/10, Heat: ${latestRSI.toFixed(1)})`);
